class Solution {
    ...
    private boolean backtrack(char[][] board, int row, int col, int index, char[] wordArray) {
        ...
        boolean find = backtrack(board, row + 1, col, index + 1, wordArray) || backtrack(board, row - 1, col, index + 1, wordArray) || backtrack(board, row, col + 1, index + 1, wordArray) || backtrack(board, row, col - 1, index + 1, wordArray);
